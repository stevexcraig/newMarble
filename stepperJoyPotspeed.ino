...
#define Y_pin A1 // Pin A1 connected to the potentiometer
#define Limit01 2 // Pin 2 connected to Limit switch out
#define Limit02 3 // Pin 3 connected to Limit switch out
#define Limit03 4 // Pin 2 connected to Limit switch out
#define Limit04 5 // Pin 3 connected to Limit switch out

const int UPdownSpeed = 100; // Minimum speed (fast)
const int LRSpeed = 350; // Maximum speed (slow)
...
void setup() {
  ...
  pinMode(Limit03, INPUT_PULLUP); // Enable internal pull-up resistors for limit switches
  pinMode(Limit04, INPUT_PULLUP);
  Serial.begin(115200);
}
